...
public class DoanhThu_JPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tableDoanhThu.setModel(model = new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Số Sản Phẩm Bán", "Số lượng đã bán", "Tổng giá bán", "Tổng giá chi", "Tổng nhập hàng", "Lợi nhuận"
            }
        ));
